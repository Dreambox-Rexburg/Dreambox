  ...
  return (
    <div className="flex">
      <Link
        ...
        target="_blank"
      >
        <FontAwesomeIcon icon={faFacebook} className="w-8 h-8 m-2" />
      </Link>
      <Link href="https://www.instagram.com/dreambox_rexburg/" target="_blank">
        <FontAwesomeIcon icon={faInstagram} className="w-8 h-8 m-2" />
      </Link>
      <Link
        href="https://www.tiktok.com/@dreambox_rexburg?lang=en"
        target="_blank"
      >
        <FontAwesomeIcon icon={faTiktok} className="w-8 h-8 m-2" />
      </Link>
    </div>
  );
};
